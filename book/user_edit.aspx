<%@ Page Language="VB" AutoEventWireup="false" CodeFile="user_edit.aspx.vb" Inherits="user_edit" %>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="text-align: center" class="auto-style2">
                    <asp:Button ID="loseEff" runat="server" Text="失效" BackColor="#820000" BorderColor="#FFCCCC" BorderStyle="Double" ForeColor="White" />
                </td>
                <td></td>
            </tr>
        </table>
