<%@ Page Language="VB" AutoEventWireup="false" CodeFile="book_resource_in.aspx.vb" Inherits="book_resource_in" %>
        ...
        <div>
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="lyname" runat="server" Height="40px" Width="281px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
