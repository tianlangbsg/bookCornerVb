    ...
    Protected Sub Page_Load() Handles Me.Load
        If Not IsPostBack Then
            ...
            If message IsNot Nothing Then
                ...
                SuccessMessageText = If(message = "ChangePwdSuccess", "パスワードが変更されました。", If(message = "SetPwdSuccess", "パスワードが設定されました。", If(message = "RemoveLoginSuccess", "アカウントは削除されました。", [String].Empty)))
