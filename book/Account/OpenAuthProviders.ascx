...
<div id="socialLoginList">
    ...
    <asp:ListView runat="server" ID="providerDetails" ItemType="System.String"
        ...
        <EmptyDataTemplate>
            <div>
                <p>構成されている外部認証サービスがありません。外部サービスを介してログインをサポートするようにこの ASP.NET アプリケーションを設定する方法の詳細については、<a href="http://go.microsoft.com/fwlink/?LinkId=252803">この資料</a>を参照してください。</p>
            </div>
        </EmptyDataTemplate>
    </asp:ListView>
</div>